	...
	factory: (require) => {
		...
		*/
		...
		function modelDraftOf(model) {
			...
			const reasoningEnabled = effortsForCommandCodeModel(model).length === 0 ? void 0 : true;
			return {
				rowId: newModelRowId(),
				id: model.id,
				...
				...vision ? { vision: true } : {},
				...reasoningEnabled === void 0 ? {} : { reasoningEnabled }
			};
		}
		...
		function modelSettingsOf(draft) {
			...
			const defaultEffort = draft.reasoningEnabled === false ? void 0 : defaultEffortForCommandCodeModel(effortModel);
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Capability, {
							...
							disabled,
							onChange: (value) => patch({ vision: value ? true : void 0 })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Capability, {
							label: t("reasoning"),
							checked: reasoningChecked,
							disabled: disabled || !hasEfforts,
							onChange: (value) => patch({
								reasoningEnabled: value ? true : false,
								...value ? {} : { defaultEffort: void 0 }
							})
						}),
						hasEfforts && reasoningChecked ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							style: {
								display: "inline-flex",
								alignItems: "center",
								gap: 6,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: labelStyle,
								children: t("defaultThinking")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
								style: selectStyle,
								value: defaultEffort ?? efforts[0] ?? "",
								disabled,
								"aria-label": t("defaultThinking"),
		...
		function mergeSelected(current, selected) {
			...
			return selected.map((model) => {
				...
				return {
					...
					...prior.reasoningEnabled === void 0 ? {} : { reasoningEnabled: prior.reasoningEnabled }
				};
			});
		}
		...
		function CommandCodeSettingsCard(props) {
			...
			if (snapshot.status === "unavailable" || draft === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				style: cardStyle,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					...
					style: statusStyle,
					children: t("remoteManagementDisabled")
				})]
			});
			const title = t("title");
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: hintStyle,
												children: [interpolate(t("modelCount"), { count: draft.models.length }), draft.models.length > 0 ? " · " + t("customCatalog") : ""]
											})
										]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
