window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._4a22ef9903ecc97d27cd4434f7a4ce81/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		function decodeCommandCodeUsage(usage) {
			...
			if (monthly !== void 0) {
				...
				if (cap !== void 0 && cap > 0 && monthly <= cap) windows.push(remainingWindow({
					id: "monthly",
					label: "Month",
					used: cap - monthly,
					limit: cap
			...
			for (const [key, label] of [["fiveHour", "5-hour"], ["weekly", "Week"]]) {
				...
				if (item.resetAt !== void 0 && !nonEmptyString$1(item.resetAt)) return void 0;
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._4a22ef9903ecc97d27cd4434f7a4ce81/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._4a22ef9903ecc97d27cd4434f7a4ce81/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._4a22ef9903ecc97d27cd4434f7a4ce81/node_modules/dsh-llm-providers-ui/lib/provider-detail.js
		/** Non-empty string guard shared by the reader factories and the sidebar cache validator. */
...
`;
		...
		*/
		...
		function CommandCodeSettingsCard(props) {
			...
			const advancedBlock = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Capability, {
				label: t("zdr"),
			...
			if (props.mode === "detail" && draft !== void 0) {
