window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function decodeCommandCodeModel(value) {
			if (!record(value) || typeof value.id !== "string" || value.id.length === 0) return void 0;
			...
			if (value.defaultEffort !== void 0) {
				if (typeof value.defaultEffort !== "string" || value.defaultEffort.length === 0) return void 0;
				if (!effortsForCommandCodeModel({ id: value.id }).includes(value.defaultEffort)) return void 0;
			}
			let modalities;
			...
			return {
				...
				...value.defaultEffort === void 0 ? {} : { defaultEffort: value.defaultEffort },
		...
		function decodeCommandCodeDiscoveryResult(value) {
			if (!record(value) || !Array.isArray(value.models) || !Array.isArray(value.warnings)) return void 0;
			const models = [];
		...
		function decodeCommandCodeUsageView(value) {
			if (!record(value) || typeof value.fetchedAt !== "string" || !Array.isArray(value.failures)) return void 0;
		...
		*/
		...
		function patchNav() {
			...
			for (const button of document.querySelectorAll("nav button")) {
				...
				svg.innerHTML = "<path fill=\"currentColor\" fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M7 0.35a6.65 6.65 0 1 0 0 13.3A6.65 6.65 0 0 0 7 .35Zm0 1.2c.65 0 1.75 1.94 1.75 5.45S7.65 12.45 7 12.45 5.25 10.51 5.25 7 6.35 1.55 7 1.55ZM1.58 6.4h10.84v1.2H1.58V6.4Z\"/>";
			}
		}
		...
		const copy = {
			zh: {
				...
				empty: "安装一个 LLM provider 后，在这里连接账号并选择模型。"
			},
			en: {
				nav: "LLM Providers",
				title: "LLM Providers",
				subtitle: "Connect accounts and choose which models appear in the chat picker.",
				empty: "Install an LLM provider to connect an account and pick models here."
			}
		};
		...
		function ensureProviderSection(ctx) {
			...
			ctx.slots.inject("settings.section", () => {
				...
				let disposeIcon;
				const claim = () => {
					if (disposeSection !== void 0 || occupied(slots)) return;
		...
		*/
		function SortableList({ items, getId, renderItem, dragLabel, onReorder, disabled = false }) {
			...
			(0, react.useEffect)(() => {
				...
				style.textContent = "html.commandcode-sortable-dragging, html.commandcode-sortable-dragging * { cursor: grabbing !important; user-select: none !important; }";
				const previousRootCursor = document.documentElement.style.cursor;
				const previousBodyCursor = document.body.style.cursor;
				document.head.appendChild(style);
				document.documentElement.classList.add("commandcode-sortable-dragging");
				document.documentElement.style.cursor = "grabbing";
				document.body.style.cursor = "grabbing";
				return () => {
					document.documentElement.classList.remove("commandcode-sortable-dragging");
					style.remove();
		...
		function modelSettingsOf(draft) {
			...
			const defaultEffort = defaultEffortForCommandCodeModel({
				id: draft.id.trim(),
		...
		function modelFailure(models) {
			...
			for (const model of models) {
				...
				const context = integerOf(model.contextWindow);
				const override = model.contextWindowOverride === void 0 ? void 0 : integerOf(model.contextWindowOverride);
				if (id.length === 0 || ids.has(id) || context === void 0 && override === void 0 || Number.isNaN(context) || Number.isNaN(override)) return true;
				ids.add(id);
			}
			return false;
		}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: labelStyle,
									children: t("contextOverride")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									style: inputStyle,
									inputMode: "numeric",
									value: model.contextWindowOverride ?? "",
									placeholder: t("useProviderContext"),
									disabled,
									"aria-label": t("contextOverride"),
									onChange: (event) => patch({ contextWindowOverride: event.target.value || void 0 })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								style: fieldStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									disabled,
									"aria-label": t("output"),
									onChange: (event) => patch({ maxTokens: event.target.value || void 0 })
								})]
							})
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: hintStyle,
							children: model.contextWindowOverride ? t("contextOverride") : model.contextWindow ? t("providerContext") : t("fallbackContext")
						})
					}),
					efforts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: hintStyle,
						children: t("effortUnavailable")
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: rowStyle,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: labelStyle,
								children: t("effortOptions")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: hintStyle,
								children: efforts.map((effort) => EFFORT_LABELS[effort] ?? effort).join(" · ")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							style: fieldStyle,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								style: inputStyle,
								value: defaultEffort ?? efforts[0] ?? "",
								disabled,
								"aria-label": t("defaultEffort"),
								onChange: (event) => patch({ defaultEffort: event.target.value }),
								children: efforts.map((effort) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: effort,
									children: EFFORT_LABELS[effort] ?? effort
								}, effort))
							})]
						})]
					})
		...
		function CommandCodeSettingsCard(props) {
			...
			const save = async () => {
				...
				setNotice(void 0);
				try {
					const accepted = await props.saveConfiguration(settingsOf(draft, snapshot.value), apiKey.trim().length === 0 ? void 0 : apiKey.trim());
			...
			if (snapshot.status === "unavailable" || draft === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
				style: cardStyle,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderCardHeader, {
						...
						summary: formatProviderSummary(t("notConfigured"), "0 " + t("models")),
						open: false
					})
				})
			});
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: hintStyle,
												children: interpolate(t("modelCount"), { count: draft.models.length })
											})
										]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
		...
		function apply(ctx) {
			...
			const describeCredential = async () => {
				const ref = scope.getSnapshot().value?.apiKeyEnv ?? "COMMANDCODE_API_KEY";
			...
			const saveConfiguration = async (settings, apiKey) => {
				...
				if (snapshot.revision === void 0) throw new Error(t("saveFailed"));
				...
				if (apiKey !== void 0 && apiKey.trim().length > 0) await storeApiKey(apiKey.trim());
				return saved;
			};
