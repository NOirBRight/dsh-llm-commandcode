...
export declare class CommandCodeModelPickerController {
    private snapshot;
    private readonly listeners;
    private onAdopt;
    /** Read the stable snapshot identity until picker state changes. */
    getSnapshot: () => CommandCodeModelPickerSnapshot;
...
export declare function CommandCodeModelPicker(props: CommandCodeModelPickerProps): ReactNode;
export {};
//# sourceMappingURL=CommandCodeModelPicker.d.ts.map