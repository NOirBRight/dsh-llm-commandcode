...
const PACKAGE_ID = 'dsh-llm-commandcode'
...
const host: UserConfig = {
  ...
  deps: { neverBundle: [
    '@deepseek-ai/cordis', '@deepseek-ai/schemastery', '@deepseek-ai/dsh-attachment',
    '@deepseek-ai/dsh-credentials', '@deepseek-ai/dsh-llm',
    '@deepseek-ai/dsh-llm-pi-ai', '@deepseek-ai/dsh-settings', '@deepseek-ai/dsh-timeout',
  ] },
}
...
const client: UserConfig = {
  ...
  plugins: [{
    ...
    resolveId(source: string) {
      ...
      throw new Error('client bundle purity: ' + source + ' is not a web module-table entry')
    },
  }],
